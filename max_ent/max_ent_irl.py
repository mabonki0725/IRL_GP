...
class MaxEntIRL:
	...
	"""
	print(window_size,self.grid_size,grid_dim)
	dmy1 = window_size / self.grid_size * grid_dim[1]
	dmy2 = window_size / self.grid_size * grid_dim[0]
	dmy = [dmy1,dmy2]
	self.grid_gui = GuiBoard("MaxEnt IRL",dmy, pix_per_grid)
	"""
